 ...
 */
export declare class AccountAssetHolding extends BaseModel {
    /**
 ...
 */
export declare class AccountAssetsInformationResponse extends BaseModel {
    /**
     * The round for which this information is relevant.
     */
    round: number | bigint;
    ...
    static from_obj_for_encoding(data: Record<string, any>): AccountAssetsInformationResponse;
}
/**
 * AccountParticipation describes the parameters used by this account in consensus
 * protocol.
 ...
 */
export declare class AppCallLogs extends BaseModel {
    /**
 ...
 * Block header.
 */
export declare class BlockHeaderResponse extends BaseModel {
    /**
     * Block header data.
     */
 ...
 * inner app calls)
 */
export declare class BlockLogsResponse extends BaseModel {
    logs: AppCallLogs[];
    /**
